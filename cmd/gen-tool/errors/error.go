 ...
 * @LastEditTime: 2023-05-25 16:51:46
 * @Description: errors
 */
package errors
...
var ErrProtobufNameIsEmpty = errors.New("err : protobufname is empty; please check")
...
var ErrAstNodeIsEmpty = errors.New("err : astNode is empty")
var ErrAstNodeInterfaceMethodIsEmpty = errors.New("err : astNode interface method is empty")
var ErrAstNodeInterfaceHttpRuleMapIsEmpty = errors.New("err : astNode interface httpRuleMap is empty")
