...
type UpdateDemoReq struct {
	...
	Id  int32          `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`  // 应用ID
	Obj *UpdateMessage `protobuf:"bytes,2,opt,name=obj,proto3" json:"obj,omitempty"` // 更新信息
}
...
func (x *GetTestFourReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTestFourReq) ProtoMessage() {}

func (x *GetTestFourReq) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTestFourReq.ProtoReflect.Descriptor instead.
func (*GetTestFourReq) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{7}
}

func (x *GetTestFourReq) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetTestFourResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTestFourResp) ProtoMessage() {}

func (x *GetTestFourResp) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTestFourResp.ProtoReflect.Descriptor instead.
func (*GetTestFourResp) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{8}
}

func (x *GetTestFourResp) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetTestFourResp) GetApp() string {
	if x != nil {
		return x.App
	}
	return ""
...
func (x *GetTestFourResp) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
var file_demo_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0x2c, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x46, 0x6f, 0x75,
	0x72, 0x52, 0x65, 0x71, 0x12, 0x1a, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x42, 0x0a, 0xca, 0xb0, 0x87, 0x4d, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x52, 0x02, 0x69, 0x64,
	0x22, 0x4d, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73, 0x74, 0x46, 0x6f, 0x75, 0x72, 0x52,
	...
	,
}
...
var file_demo_proto_goTypes = []interface{}{
	...
	(*GetTestFourReq)(nil),  // 7: demo.GetTestFourReq
	(*GetTestFourResp)(nil), // 8: demo.GetTestFourResp
}
var file_demo_proto_depIdxs = []int32{
	...
	7, // 5: demo.DemoApi.TestFour:input_type -> demo.GetTestFourReq
	0, // 6: demo.DemoApi.AddDemo:output_type -> demo.Empty
	0, // 7: demo.DemoApi.DeleteDemo:output_type -> demo.Empty
	0, // 8: demo.DemoApi.UpdateDemo:output_type -> demo.Empty
	6, // 9: demo.DemoApi.GetDemo:output_type -> demo.GetDemoResp
	8, // 10: demo.DemoApi.TestFour:output_type -> demo.GetTestFourResp
...
type DemoApiClient interface {
	...
	// 查找getTestFour的详细描述
	TestFour(ctx context.Context, in *GetTestFourReq, opts ...grpc.CallOption) (*GetTestFourResp, error)
}
...
func (c *demoApiClient) TestFour(ctx context.Context, in *GetTestFourReq, opts ...grpc.CallOption) (*GetTestFourResp, error) {
	out := new(GetTestFourResp)
	err := c.cc.Invoke(ctx, "/demo.DemoApi/TestFour", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoApiServer interface {
	...
	// 查找getTestFour的详细描述
	TestFour(context.Context, *GetTestFourReq) (*GetTestFourResp, error)
}
...
func (*UnimplementedDemoApiServer) TestFour(context.Context, *GetTestFourReq) (*GetTestFourResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestFour not implemented")
}
...
func _DemoApi_TestFour_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTestFourReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoApiServer).TestFour(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.DemoApi/TestFour",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoApiServer).TestFour(ctx, req.(*GetTestFourReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DemoApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TestFour",
			Handler:    _DemoApi_TestFour_Handler,
		},
	},
